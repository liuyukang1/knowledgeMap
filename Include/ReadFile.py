...
import Include.ReadJson
from Include.OprateNeo4j import Operate
...
if __name__ == '__main__':
    data_path = "F:\\knowledgeMap\\announcements.xlsx"                                     #文件的绝对路径
    sheetname = "Sheet1"
    ...
    while counter < 10:
        if list[counter] == '':
            counter += 1
            continue
        newlist = Include.ReadJson.readJson(list[counter])
        counter += 1
